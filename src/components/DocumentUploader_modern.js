...
const DocumentUploader = ({ connectionId, onUploadComplete }) => {
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        alert(`Successfully uploaded ${selectedFile.name}! Processed ${result.rows_processed || 0} rows.`);
      } else {
      ...
      <div className="panel-container">
        ...
        <div className="upload-section">
          ...
          >
            ...
            />
            <label htmlFor="fileInput" className="file-input-overlay"></label>
          </div>

          <div className="upload-actions">
            <button
              onClick={handleUpload}
              disabled={!selectedFile || isUploading || !connectionId}
          ...
          {!connectionId && (
            <div className="warning-card">
              ...
              <div className="warning-content">
                ...
                <p>Please connect to a database first in the Database tab before uploading files.</p>
              </div>
            </div>
          )}
        </div>
